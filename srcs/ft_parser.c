...
int	ft_setup_parser(t_struktur **struktur)
{
	*struktur = ft_calloc(sizeof(t_struktur), 1);
	(*struktur)->index_counter = 0;
	(*struktur)->lex_element = g_access.lexor2parser;
	(*struktur)->return_flag = 0;
	return (0);
}
