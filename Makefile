...
SRC			=  main.c ft_lexor.c ft_parser.c ft_executor.c ft_initiator.c ft_echo_utils.c ft_builtins2.c ft_builtins.c ft_global_fun.c \
				...
				ft_parser_utils3.c ft_pipex_utils.c ft_pipex_utils2.c ft_pipex_utils3.c
